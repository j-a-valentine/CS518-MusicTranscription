...
class GUI:
    ...
    def load_window(self, ai_prediction, submit_callback, audio_callback):
        ...
        ai_label = ttk.Label(frame, text="AI Predicted Lyrics", font=('Arial', 20, 'bold'))
        ai_label.grid(row=0, column=0, padx=10, pady=10, sticky="w")

        ai_text = ttk.Label(frame, text=ai_prediction, wraplength=950, justify='left', font=('Arial', 16), foreground='#333333')
